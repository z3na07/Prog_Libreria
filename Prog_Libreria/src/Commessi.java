...
public class Commessi
{
    private String nome;
    private String cognome;
    final private String password = "Letsgoski";

    public Commessi(String _nome, String _cognome, String _password)
    {
        this.nome = _nome;
    ...
    private static Commessi Inserimento(Commessi commesso, Scanner input)
    {
        System.out.println("Inserisci il nome");
        commesso.setNome(input.nextLine());

        System.out.println("Inserisci il cognome");
        commesso.setCognome(input.nextLine());
